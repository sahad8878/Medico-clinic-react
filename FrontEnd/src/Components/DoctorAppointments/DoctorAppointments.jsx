...
<button  onClick={()=>acceptAppointment(appointment._id)} className="p-1.5 text-xs font-medium uppercase tracking-wider text-white bg-[#194569] rounded-lg bg-opacity-80 hover:bg-opacity-50">Accept</button>

<button  onClick={()=>rejectAppointment(appointment._id)} className="p-1.5 ml-5 text-xs font-medium uppercase tracking-wider text-red-700 bg-[#194569] rounded-lg bg-opacity-80 hover:bg-opacity-50">Reject</button>
